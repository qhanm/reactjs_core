                                ...
                                <div className="col-4">
                                    <div className="status">
                                        ...
                                        <select defaultValue="" className="custom-select">
                                            <option value={0}>SELECTED FOR DEVELOPMENT</option>
                                    ...
                                    <div className="assignees">
                                        ...
                                        <div style={{display: 'flex'}}>
                                            <div style={{display: 'flex'}} className="item">
                                                ...
                                                <p className="name">
                                                    Pickle Rick
                                                    <i className="fa fa-times" style={{marginLeft: '5px'}} />
                                                </p>
                                            </div>
                                            <div style={{display: 'flex', alignItems: 'center'}}>
                                                <i className="fa fa-plus" style={{marginRight: '5px'}} /><span>Add more</span>
                                            </div>
                                        </div>
                                    </div>
